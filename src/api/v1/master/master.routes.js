...
export default Express.Router()
  ...
  .get("/roles", authorization("ADMIN", "BUHR", "HR_OPS", "SUPERADMIN"), masterController.roles)
  .get("/shift", authorization("ADMIN", "BUHR", "HR_OPS", "SUPERADMIN"), masterController.shift)
  .get("/attendance-policy", authorization("ADMIN", "BUHR", "HR_OPS", "SUPERADMIN"), masterController.attendancePlicy)
  .get("/weekoff", authorization("ADMIN", "BUHR", "HR_OPS", "SUPERADMIN"), masterController.weekoff)
  .get("/sbu", authorization("ADMIN", "BUHR", "HR_OPS", "SUPERADMIN"), masterController.sbu)
  .get("/buhr", authorization("ADMIN", "BUHR", "HR_OPS", "SUPERADMIN"), masterController.buhr)
