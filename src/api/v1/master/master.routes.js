...
export default Express.Router()
  ...
  .get("/roles", authorization("ADMIN", "BUHR", "HR_OPS"), masterController.roles)
  .get("/shift", authorization("ADMIN", "BUHR", "HR_OPS"), masterController.shift)
  .get("/attendance-policy", authorization("ADMIN", "BUHR", "HR_OPS"), masterController.attendancePlicy)
  .get("/weekoff", authorization("ADMIN", "BUHR", "HR_OPS"), masterController.weekoff)
  .get("/sbu", authorization("ADMIN", "BUHR", "HR_OPS"), masterController.sbu)
  .get("/buhr", authorization("ADMIN", "BUHR", "HR_OPS"), masterController.buhr)
  .get("/buhead", authorization("ADMIN", "BUHR", "HR_OPS"), masterController.buhead)
  .get("/probation", authorization("ADMIN", "BUHR", "HR_OPS"), masterController.probation)
  .get("/newCustomerName", authorization("ADMIN", "BUHR", "HR_OPS"), masterController.newCustomerName)
