...
export default Express
    ...
    .get("/taskHistoryLeave", authentication.authenticate, userController.taskHistoryLeave)
    .get("/separationTaskForm/:id", authentication.authenticate, userController.separationTaskForm)
