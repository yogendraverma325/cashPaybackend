...
db.buMapping.hasOne(db.employeeMaster, { foreignKey: "id", sourceKey: "buHrId",as: "buHeadData"});
db.buMapping.hasOne(db.employeeMaster, { foreignKey: "id", sourceKey: "headId",as: "buhrData"});
